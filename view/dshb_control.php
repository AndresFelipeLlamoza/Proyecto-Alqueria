...
<div id="overlay"></div>
    ...
    $data = "SELECT contratistas.*, rutas.nombre_ruta FROM contratistas LEFT JOIN rutas ON contratistas.id_ruta = rutas.id_ruta WHERE estado = 'Activo'";
            ...
            <div class="filteritems">
                ...
                <div class="contratcontain" id="listcontratroute">
                    ...
                    foreach ($result as $row){
                        echo "
                            <a class='modalruta' href='../view/contratistdetail.php?id=".$row['id']."&nombre_ruta=".$row['nombre_ruta']."&Nombre=".$row['Nombre']."'>
